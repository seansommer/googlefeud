...
- Google-protected master and host sign-in
...
| Accounts and live game state | Firebase Anonymous/Google Authentication + Realtime Database Spark plan | Free within the family-sized quotas |
...
2. Sign in with Google and securely mark that protected account as the master user.
...
- Host and master access requires Google Sign-In and cannot be granted to an instant player profile.
